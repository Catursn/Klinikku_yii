...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model2,'obat'); ?>
		<?php echo $form->textField($model2,'obat'); ?>
		<?php echo $form->error($model2,'obat'); ?>
	</div> 

	<div class="row">
		<?php echo $form->labelEx($model2,'jumlah'); ?>
		<?php echo $form->textField($model2,'jumlah'); ?>
